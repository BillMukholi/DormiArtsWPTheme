<?php
/**
 * Dormi Arts functions and definitions
 *
 ...
 */
function dormi_arts_setup() {
	/*
		* Make theme available for translation.
		* Translations can be filed in the /languages/ directory.
		* If you're building a theme based on Dormi Arts, use a find and replace
		* to change 'dormi_arts' to the name of your theme in all the template files.
		*/
	load_theme_textdomain( 'dormi_arts', get_template_directory() . '/languages' );
	...
	register_nav_menus(
		array(
			'menu-1' => esc_html__( 'Primary', 'dormi_arts' ),
		)
	);
	...
	add_theme_support(
		'custom-background',
		apply_filters(
			'dormi_arts_custom_background_args',
			array(
...
add_action( 'after_setup_theme', 'dormi_arts_setup' );
 ...
 */
function dormi_arts_content_width() {
	$GLOBALS['content_width'] = apply_filters( 'dormi_arts_content_width', 640 );
}
add_action( 'after_setup_theme', 'dormi_arts_content_width', 0 );
 ...
 */
function dormi_arts_widgets_init() {
	register_sidebar(
		array(
			'name'          => esc_html__( 'Sidebar', 'dormi_arts' ),
			'id'            => 'sidebar-1',
			'description'   => esc_html__( 'Add widgets here.', 'dormi_arts' ),
...
add_action( 'widgets_init', 'dormi_arts_widgets_init' );
